...
import com.jzkj.common.config.config.swaggerbootstrapui.annotations.EnableSwaggerBootstrapUI;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("鉴真科技")
                .description("鉴真科技移动接口文档")
                .version("1.0.0")
                .contact(new Contact("张宾", "https://www.jz315.net", "13141498695@163.com"))
                .build();
    }
